...
public class Constants {
	...
	// Browser paths   cbiit-test-automation\Framework\framework-resources\drivers
	public static final String CHROME_PATH = "Framework"+File.separator+"framework-resources"+File.separator+"drivers"+File.separator+"chromedriver";
